...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView test_id,test_pw;
    SessionCallback callback;
    Button btn_nomal_login,btn_register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_nomal_login = (Button) findViewById(R.id.btn_nomal_login);
        btn_nomal_login.setOnClickListener(this);
